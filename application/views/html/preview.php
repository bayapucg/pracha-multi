...
<head>
  <meta charset="utf-8">
  <title><?php echo isset($logo_details['title'])?$logo_details['title']:'Pracha Multi'; ?></title>
...
<body>
    ...
    <div class="container-fluid">
      ...
      <div id="logo" class="pull-left logo-header">
	    ...
	    <?php if($logo_details['image']==''){ ?>
		   <img src="<?php echo base_url(); ?>assets/vendor/img/logo.png" alt="logo">
		  <?php }else{ ?>
		  <img src="<?php echo base_url('assets/logo/'.$logo_details['image']); ?>" alt="logo">
		  <?php } ?>
			  ...
			  <div class="carousel-item active">
				...
				<div class="carousel-container">
				  <div class="carousel-content">
					<h2><?php echo isset($list['text'])?$list['text']:''; ?></h2>
    ...
    <section id="about">
      <div class="container">
        ...
        <header class="section-header">
          <h3>About Us</h3>
          <p><?php echo isset($aboutus_details['parahraph'])?$aboutus_details['parahraph']:''; ?></p>
        </header>
    ...
    <section id="services">
      <div class="container">
        ...
        <header class="section-header wow fadeInUp">
          <h3>Services</h3>
          <p><?php echo isset($services_details['paragraph'])?$services_details['paragraph']:''; ?>.</p>
        </header>

        <div class="row">

          <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
            <h4 class="title"><a href=""><?php echo isset($services_details['title1'])?$services_details['title1']:''; ?></a></h4>
			<p><?php echo isset($services_details['paragraph1'])?$services_details['paragraph1']:''; ?>.</p> 
			</div>
          <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
            <h4 class="title"><a href=""><?php echo isset($services_details['title2'])?$services_details['title2']:''; ?></a></h4>
			<p><?php echo isset($services_details['paragraph2'])?$services_details['paragraph2']:''; ?>.</p>
			</div>
          <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
            <h4 class="title"><a href=""><?php echo isset($services_details['title3'])?$services_details['title1']:''; ?></a></h4>
           <p><?php echo isset($services_details['paragraph3'])?$services_details['paragraph3']:''; ?>.</p>
			</div>
          <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-delay="0.1s" data-wow-duration="1.4s">
            <h4 class="title"><a href=""><?php echo isset($services_details['title4'])?$services_details['title4']:''; ?></a></h4>
           <p><?php echo isset($services_details['paragraph4'])?$services_details['paragraph4']:''; ?>.</p>
			</div>
          <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-delay="0.1s" data-wow-duration="1.4s">
            <h4 class="title"><a href=""><?php echo isset($services_details['title5'])?$services_details['title5']:''; ?></a></h4>
            <p><?php echo isset($services_details['paragraph5'])?$services_details['paragraph5']:''; ?>.</p>
			</div>
          <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-delay="0.1s" data-wow-duration="1.4s">
            <h4 class="title"><a href=""><?php echo isset($services_details['title6'])?$services_details['title6']:''; ?></a></h4>
            <p><?php echo isset($services_details['paragraph6'])?$services_details['paragraph6']:''; ?>.</p>
			</div>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
		  ...
		  <?php } ?>
            ...
            <p><?php echo isset($contactus_details['address'])?$contactus_details['address']:''; ?></p></div>
          </div>
          ...
          <div class="col-lg-4 footer-contact">
            <h4>Contact Us</h4>
            <p>
              <strong>Phone:</strong> <?php echo isset($contactus_details['phone'])?$contactus_details['phone']:''; ?><br>
              <strong>Email:</strong> <?php echo isset($contactus_details['email'])?$contactus_details['email']:''; ?><br>
            </p>
    ...
    <div class="container">
      ...
      <div class="col-md-8">
      <div class="copyright">
        &copy; Copyright <strong><?php echo isset($logo_details['title'])?$logo_details['title']:'Pracha Multi'; ?></strong>. All Rights Reserved
      </div>
      <div class="credits">
