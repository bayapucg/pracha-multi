						...
						<div class="clearfix">&nbsp;</div>
							...
							<?php if(isset($aboutus_list) && count($aboutus_list)>0){ ?>
									...
									<thead>
										<tr>
											<th >Paragraph</th>
											<td colspan="2"><?php echo isset($aboutus_list['parahraph'])?$aboutus_list['parahraph']:''; ?></td>
									...
									<tbody>
										...
										<tr>
											...
											<td><?php echo isset($aboutus_list['paragraph1'])?$aboutus_list['paragraph1']:''; ?></td>
										...
										<tr>
											...
											<td><?php echo isset($aboutus_list['paragraph2'])?$aboutus_list['paragraph2']:''; ?></td>
											<td class="text-center">
										...
										<tr>
											...
											<td><?php echo isset($aboutus_list['paragraph3'])?$aboutus_list['paragraph3']:''; ?></td>
											<td class="text-center">
